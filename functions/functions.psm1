...
Export-ModuleMember -Function Set-CaseFolders, Show-Message, Show-FinishMessage, Show-OutputSavedToFile, Get-LineNum, Save-Output, Save-OutputAppend, Write-LogEntry, Write-LogFinishedMessage, Write-LogOutputAppended, Write-LogOutputSaved, Write-NoDataFound, -Variable Dlu, StartTime, RunDate, Ipv4, Ipv6, ComputerName, CaseFolderName, LogFile, NoMatchingEventsMsg, ExecutableFileTypes, TestingFolder, DeviceFolder, UserFolder, NetworkFolder, ProcessFolder, SystemFolder, PrefetchFolder, EventLogFolder, FirewallFolder, BitLockerFolder, LogFolder
