...
Show-Message -Message "`nModule file: '$($FunctionsModule)' was imported successfully" -NoTime -Blue


$HtmlModule = ".\html\Export-HtmlReport.psm1"
Import-Module -Name $HtmlModule -Force -Global
Show-Message -Message "Module file: '$($HtmlModule)' was imported successfully" -NoTime -Blue


$FilesModule = ".\files\Export-FilesReport.psm1"
Import-Module -Name $FilesModule -Force -Global
Show-Message -Message "Module file: '$($FilesModule)' was imported successfully" -NoTime -Blue


$GuiModule = ".\gui\GuiMain.psm1"
Import-Module -Name $GuiModule -Force -Global
Show-Message -Message "Module file: '$($GuiModule)' was imported successfully" -NoTime -Blue
