...
function Get-Gui {
    ...
    $cbRegHives.Font = New-Object System.Drawing.Font("Arial", 11)
    $cbRegHives.Width = 250
    $cbRegHives.Location = New-Object System.Drawing.Point(150, 210)  # (x, y) position
    $Form.Controls.Add($cbRegHives)
    ...
    $cbNTUserDat.Location = New-Object System.Drawing.Point(150, 240)  # (x, y) position
    ...
    $cbListFiles.Location = New-Object System.Drawing.Point(150, 270)  # (x, y) position
    ...
    $lblDrivesList.Location = New-Object System.Drawing.Point(10, 295)  # (x, y) position -> 25 pt down
    ...
    $tbDrivesList.Location = New-Object System.Drawing.Point(150, 295)  # (x, y) position
    $tbDrivesList.Enabled = $false
    ...
    $cbKeyWordSearch.Location = New-Object System.Drawing.Point(150, 325)  # (x, y) position
    ...
    $lblKeyWords.Location = New-Object System.Drawing.Point(10, 350)  # (x, y) position
    ...
    $tbKeyWordsDrivesList.Location = New-Object System.Drawing.Point(150, 350)  # (x, y) position
    $tbKeyWordsDrivesList.Enabled = $false
    ...
    $cbHashFiles.Location = New-Object System.Drawing.Point(150, 380)  # (x, y) position
    ...
    $cbArchive.Width = 250
    $cbArchive.Location = New-Object System.Drawing.Point(150, 410)  # (x, y) position
