...
function Show-Message {
    ...
    switch ($Color) {
        ...
        "Blue" {
            ...
            Write-Host $FormattedMessage -ForegroundColor Blue
        ...
        "Green" {
            ...
            Write-Host $FormattedMessage -ForegroundColor DarkGreen

        }

        "Magenta" {

            Write-Host $FormattedMessage -ForegroundColor DarkMagenta

        }

        "Red" {

            Write-Host $FormattedMessage -ForegroundColor DarkRed

        }

        "Yellow" {

            Write-Host $FormattedMessage -ForegroundColor DarkYellow

        }

        "RedOnGray" {

            Write-Host $FormattedMessage -ForegroundColor DarkRed -BackgroundColor Gray

        }

        "YellowOnRed" {

            Write-Host $FormattedMessage -ForegroundColor DarkYellow -BackgroundColor DarkRed
